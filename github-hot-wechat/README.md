...
下面是一次真实运行生成的公众号封面与微信 HTML 预览。文章包含可复制工具栏、开场、项目分节、实际配图、许可证和风险说明。

### 合并封面

左侧为公众号横版封面，右侧为方形封面安全区；同时会导出两个独立裁切文件。

![真实生成的公众号合并封面](assets/preview-cover.png)

### 微信公众号正文

打开生成的 `微信版.html` 后，可点击顶部“复制公众号正文”，再粘贴到微信公众号编辑器。

![真实生成的微信公众号正文预览](assets/preview-article.png)

## 四套主题

实际颜色、编号、封面和信息块会按所选主题联动变化：

![四套主题说明](assets/preview.svg)
